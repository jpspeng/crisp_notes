...
4. Write a loop to take add the first 10 even numbers, and then write another loop 
to divide the result repeatedly by the first 5 odd numbers. Then write code to 
round the result to three digits. What is the answer? 
